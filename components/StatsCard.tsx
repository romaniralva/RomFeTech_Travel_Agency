    ...
    <article className='stats-card'>
        ...
        <div className='content'>
            <div className='flex flex-col gap-4'>
                <h2 className='text-4xl semi-bold'>{total}</h2>
            ...
            <img src={`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg'}`} className='xl:w-32 w-full h-full md:h-32 xl:h-full' alt='tend graph'/> 
        </div>
    </article>
  )
}
