...
import { ButtonComponent, classNames } from '@syncfusion/ej2-react-buttons';
...
const CreateTrip = ({loaderData} :Route.ComponentProps) => {
  ...
  return (
    <main className='flex flex-col gap-10 pb-20 wrappwer'>
            ...
            <form className='trip-form' onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input 
                        ...
                        name='duration'
                        type="number"
                        placeholder ='Enter a number days (5, 12 ...)'
